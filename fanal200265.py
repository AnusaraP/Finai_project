...
while ret:
    ...
    if template != -1:
        ...
        if center_match is not None or len(center_match)==2:
            ...
            if safezone_val > 200 : 
                cv2.putText(frame,'turn_left',(20,450),cv2.FONT_HERSHEY_COMPLEX_SMALL,1,(203,55,0),2)
                turn_left()
            elif safezone_val < 100 :
                cv2.putText(frame,'turn_Right',(20,450),cv2.FONT_HERSHEY_COMPLEX_SMALL,1,(203,55,0),2)
                turn_Right()


            else :
                cv2.putText(frame,'direct',(20,450),cv2.FONT_HERSHEY_COMPLEX_SMALL,1,(230,55,0),2)
                print("direct")
